...
namespace _1brc
{
    ...
    /// 
    /// </summary>
    internal static class ByteSearcherHelper
    {
        ...
        public static IByteSearcher Create_ByteSearcher( byte searchByte, byte[] readBuffer ) => Vector256.IsHardwareAccelerated ? new ByteSearcher_With_Intrinsics_v2( searchByte, readBuffer ) : new ByteSearcher( searchByte );
    ...
    /// 
    /// </summary>
    unsafe internal class ByteSearcher_With_Intrinsics_v2 : ByteSearcher_Base
    {
        protected const int VECTOR256_SIZE_IN_BYTES = 32; // (Vector256< byte >.Count >> 3);
        protected const int VECTOR128_SIZE_IN_BYTES = 16; // (Vector128< byte >.Count >> 3);
        protected const int VECTOR64_SIZE_IN_BYTES  = 8;  // (Vector64< byte >.Count >> 3);
        ...
        public ByteSearcher_With_Intrinsics_v2( byte searchByte, byte[] readBuffer )
        {
            Debug.Assert( Vector256.IsHardwareAccelerated );
        ...
        ~ByteSearcher_With_Intrinsics_v2() => _Buf_GCHandle.Free();
        public override void Dispose()
        {
